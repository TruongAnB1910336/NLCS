...
<script>
    ...
    <h1 style="padding:20px";><b>Cập Nhật Sản Phẩm</b></h1>
  ...
  <div class="container-fluid">
    ...
    <?php
      $id_sp=$_SESSION['edit'];
      $sql_capnhat=mysqli_query($conn,"select * from sanpham where id='$id_sp'");
    ?>
    <?php 
      while($row_capnhat=mysqli_fetch_array($sql_capnhat)){
    ?>
    <form action="quanlysp.php" method="POST" enctype="multipart/form-data">
        <div class="mb-3" style="margin-left:30%";>
            <label for="tensp" class="form-label"><b>Tên sản phẩm</b></label>
            <input type="text" class="form-control" name="tensp" value="<?php echo $row_capnhat['tensp']  ?>" placeholder="Tên sản phẩm" style="width:70%";>
        </div>
        <div class="mb-3" style="margin-left:30%";>
            <label for="img" class="form-label"><b>Hình ảnh</b></label>
            <input type="file" class="form-control" name="img" style="width:70%";>
            <img style="width: 100px;" src="<?php echo $row_capnhat['image']  ?>">
        </div>
        <div class="mb-3" style="margin-left:30%";>
            <label for="giagoc" class="form-label"><b>Giá gốc</b></label>
            <input type="text" class="form-control" name="giagoc" value="<?php echo $row_capnhat['giacu']  ?>" style="width:70%";>
        </div>
        <div class="mb-3" style="margin-left:30%";>
            <label for="giakm" class="form-label"><b>Giá khuyến mãi</b></label>
            <input type="text" class="form-control" name="giakm" value="<?php echo $row_capnhat['giamoi']  ?>" style="width:70%";>
        </div>
        <div class="mb-3" style="margin-left:30%";>
            <label for="content1" class="form-label"><b>Giới thiệu 1</b></label>
            <input type="text" class="form-control" name="content1" value="<?php echo $row_capnhat['content1']  ?>" style="width:70%";>
        </div>
        <div class="mb-3" style="margin-left:30%";>
            <label for="content2" class="form-label"><b>Giới thiệu 2</b></label>
            <input type="text" class="form-control" name="content2" value="<?php echo $row_capnhat['content2']  ?>" style="width:70%";>
        </div>
        <div class="mb-3" style="margin-left:30%";>
            <select name="loai" class="form-control" style="width:70%";>
                <!-- <option value="0">Chọn nơi thêm sản phẩm vào</option>    -->
                <option value="<?php echo $row_capnhat['loai'] ?>"><?php echo $row_capnhat['loai']  ?></option>   
                <option value="Đồng Hồ Thông Minh Bán Chạy Nhất">Đồng Hồ Thông Minh Bán Chạy Nhất</option>
            </select>
        </div>
        <div class="mb-3" style="margin-left:30%";>
            <input type="submit" class="form-control btn-primary" name="capnhat" style="width:70%"; value="Cập nhật">
        </div>
    </form>
        <?php }?>
    </main>
